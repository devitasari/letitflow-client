<template>
  <div>
    <div v-if="answer.question.title"><b>{{ answer.question.title }}</b></div>
    <div v-if="!editing" class="d-flex mt-4 py-2" style="border-bottom: solid 1px black">
      ...
      <div class="d-flex flex-column align-items-start justify-content-between mr-auto">
        ...
        <br>
        by: {{ answer.user.name }}
        <div v-html="answer.description" class="mt-3"></div>
      </div>
      <div class="d-flex flex-column justify-content-between align-items-end">
        <div id="action" class="" v-if="$store.state.auth.payload._id == answer.user._id">
